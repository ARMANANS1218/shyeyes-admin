...
const UserManagement = () => {
  useDocumentTitle("User Management"); // This will set the title as "User Management - Agent Dashboard | ShyEyes"
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6 flex items-center justify-center transition-colors">
        <div className="text-center">
          ...
          <p className="text-blue-600 dark:text-white font-semibold">Loading users...</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6 flex items-center justify-center transition-colors">
        <div className="text-center">
          <p className="text-red-600 font-semibold mb-4 dark:text-white">
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6 transition-colors text-gray-900 dark:text-white">
      {/* Header */}
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-3xl font-bold text-blue-600 dark:text-white flex items-end justify-center gap-2">
          👥 Manage Users
          <span className="text-lg  font-bold text-gray-600 dark:text-white">
        ...
        <div className="flex gap-4">
          ...
          <input
            ...
            className="p-2 rounded-lg border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
          />
      ...
      <div className="overflow-x-auto">
        <table className="w-full bg-white dark:bg-gray-800 rounded-xl shadow-md mt-5 transition-colors text-gray-900 dark:text-white">
          <thead>
          ...
          <tbody>
            {filteredUsers.length > 0 ? (
                ...
                >
                  ...
                  <td className="p-3 flex gap-2">
                    ...
                    <button
                      ...
                      className="bg-gray-600 dark:bg-pink-600 text-white p-2 rounded-full hover:bg-red-600 transition-colors"
                      title="Delete"
                    >
                      <FaTrash />
                    </button>
              ...
              <tr>
                <td colSpan="7" className="text-center p-4 text-gray-600 dark:text-white">
                  No users found.
                </td>
              </tr>
            )}
