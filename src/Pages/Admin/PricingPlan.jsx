    ...
    <div className="min-h-screen p-6 md:p-10 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {plans.map((plan, index) => (
          <div
            key={index}
            className="text-white shadow-sm rounded-xl p-3 md:p-4 text-center hover:shadow-md transition-transform hover:-translate-y-1 border border-white/20 dark:border-white/10"
      ...
      {/* Users Table */}
      <h2 className="text-xl font-semibold mb-3">📊 Users & Plans</h2>
      <div className="overflow-x-auto bg-white dark:bg-gray-800 shadow-sm rounded-xl border border-gray-200 dark:border-gray-700">
